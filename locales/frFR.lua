...
L.SETTINGS_QA_TITLE =					"Qualité minimale assurée"
L.SETTINGS_QA_TOOLTIP =					"Puisque le jeu ne peut assurer une qualité minimale, ajoutons-en quelques-unes de notre cru. Supprimer le spam du titre lors de la connexion et le <Clic droit pour les paramètres du cadre> dans les info-bulles.\n\n" .. L.REQUIRES_RELOAD
